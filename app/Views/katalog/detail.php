...
<div class="container mt-2 d-flex align-items-start justify-content-center">
 ...
 <table class="table table-striped">
  ...
  <tr>
   <td>No. Barcode</td>
   <td><?= $collections_show[0]['NomorBarcode'] ?></td>
  </tr>
  <tr>
   <td>No. Panggil</td>
   <td><?= $collections_show[0]['CallNumber'] ?></td>
  </tr>
  <tr>
   <td>Akses</td>
   <td><?= $collections_show[0]['akses'] ?></td>
  </tr>
  <tr>
   <td>Lokasi</td>
   <td><?= $collections_show[0]['lokasi'] ?></td>
  </tr>
  <tr>
   <td>Ketersediaan</td>
   <td><?= $collections_show[0]['ketersediaan'] ?></td>
  </tr>
 </table>
</div>
