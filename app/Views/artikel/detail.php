...
<div class="container mt-2 d-flex align-items-start justify-content-center">
    <?php if (!empty($collections_detail)): ?>
        <img class="img-thumbnail" style="height: 370px;" src="<?= base_url(); ?>uploaded_files/sampul_artikel/original/Monograf/<?= $collections_detail[0]['CoverURL'] ?>" class="d-block w-100" alt="...">
    ...
    <?php else: ?>
        <div class="alert alert-danger" role="alert">
            Data detail artikel tidak ditemukan.
        </div>
    <?php endif; ?>
    ...
    <?php else: ?>
        <div class="alert alert-danger" role="alert">
            Data detail tampilan artikel tidak ditemukan.
        </div>
    <?php endif; ?>
</div>
