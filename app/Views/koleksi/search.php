   ...
   <div class="col-lg-12 d-flex flex-column justify-content-center" data-aos="zoom-out">
    <nav class="navbar">
     <div class="search-container col-lg-12 m-0 p-0">
      ...
      <form class="row g-3" method="get" action="<?= base_url('koleksi/search') ?>">
       <div class="col-md-11">
...
<?php else : ?>
 <?php foreach ($search as $srch) : ?>
  <div class="container mt-5 d-flex align-items-start justify-content-center">
   <img class="img-thumbnail" style="height: 170px;" src="<?= base_url(); ?>uploaded_files/sampul_koleksi/original/Monograf/<?= $srch['CoverURL'] ?>" class="d-block w-100" alt="...">
   <table class="table table-striped">
    <tr>
     <td colspan="2"><a href="<?= base_url("koleksi/detail/" . $srch['ID']); ?>" style="color:#2b45a2;"><?= $srch['Title'] ?></a></td>
    </tr>
    <tr>
